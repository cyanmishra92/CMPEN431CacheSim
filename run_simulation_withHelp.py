...
def main(args):
    ...
    directory = args.directory  # Set this to the directory containing your config files
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Run simulations in parallel on JSON configuration files.')
    parser.add_argument('--directory', type=str, default='.', help='Directory containing the JSON configuration files.')
